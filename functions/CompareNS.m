...
RegressionSubPlot(m,n,1,Reference_10min.WS_N_mean,Reference_10min.WS_S_mean,false,...
    range_MEAN,'Reference N [m/s]','Reference S [m/s]','MEAN WS');
RegressionSubPlot(m,n,2,Reference_10min.WS_N_std, Reference_10min.WS_S_std,false,...
    range_STD, 'Reference N [m/s]','Reference S [m/s]','STD WS');
RegressionSubPlot(m,n,3,Reference_10min.TI_N,     Reference_10min.TI_S,false,...
    range_TI,  'Reference N [-]',  'Reference S [-]',  'TI');
RegressionSubPlot(m,n,4,Reference_10min.WD_N_mean,Reference_10min.WD_S_mean,false,...
