...
RegressionSubPlot(m,n,2,Reference_10min.LOS_N_std, Lidar_10min.LOS_N_std,false,...
    range_STD, 'Reference N [m/s]','Lidar N [m/s]','STD LOS, North');
RegressionSubPlot(m,n,3,Reference_10min.LOS_TI_N,  Lidar_10min.LOS_TI_N,false,...
    range_TI,  'Reference N [-]',  'Lidar N [-]',  'TI LOS, North');
RegressionSubPlot(m,n,4,Reference_10min.LOS_S_mean,Lidar_10min.LOS_S_mean,false,...
    range_MEAN,'Reference S [m/s]','Lidar S [m/s]','MEAN LOS, South');
RegressionSubPlot(m,n,5,Reference_10min.LOS_S_std, Lidar_10min.LOS_S_std,false,...
    range_STD ,'Reference S [m/s]','Lidar S [m/s]','STD LOS, South');
RegressionSubPlot(m,n,6,Reference_10min.LOS_TI_S,  Lidar_10min.LOS_TI_S,false,...
