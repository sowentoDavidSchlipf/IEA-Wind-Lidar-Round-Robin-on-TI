...
% Sonic - Cup Regression (WD with intercept)
m           = 2;
n           = 2;

figure('Name','Regression Sonic-Cup')
RegressionSubPlot(m,n,1,Mast_N.USA_WShorizontal,Mast_N.WS1,false,...
    range_MEAN,'Sonic [m/s]','Cup [m/s]','North Mast: horizontal wind speed');
RegressionSubPlot(m,n,2,Mast_S.USA_WShorizontal,Mast_S.WS1,false,...
    range_MEAN,'Sonic [m/s]','Cup [m/s]','South Mast: horizontal wind speed');
RegressionSubPlot(m,n,3, Mast_N.USA_WD,          Mast_N.WD1,true,...
    range_WD,  'Sonic [deg]','Cup [deg]','North Mast: wind direction');
RegressionSubPlot(m,n,4, Mast_S.USA_WD,          Mast_S.WD1,true,...
